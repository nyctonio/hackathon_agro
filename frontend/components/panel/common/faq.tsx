    ...
    <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4">
      ...
      <div className="mt-4 flex md:justify-between md:items-start md:flex-row flex-col justify-start items-start">
        <div className=" ">
          <p className=" font-normal text-base leading-6 text-gray-600 lg:w-8/12 md:w-9/12 ">
            Here is the summary of what we do. We are a team of passionate
            engineers who are making AI solutions for agriculture. With our
            tools you can analyze the crop, soil and get pre notifications of
            all upcoming weather and locust attack.
          </p>
        </div>
      ...
      <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
        <div className=" md:w-5/12 lg:w-4/12 w-full ">
          <img
            src="https://images.unsplash.com/photo-1642391759844-16284ca0eea1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
